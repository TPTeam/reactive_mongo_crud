...
import models.RefPersistenceCompanion


trait SonPersistenceCompanion[T <: ModelObj, R <: ModelObj] {
  self: RefPersistenceCompanion[T] =>

  type FATHER = PersistenceCompanion[R] with FatherPersistenceCompanion[R,T]
